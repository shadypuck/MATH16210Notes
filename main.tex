...
\section{Discussion}
\begin{itemize}
    \item \marginnote{3/9:}Final exams will be in person from Tuesday to Friday during the reading week.
    \begin{itemize}
    ...
    \item \marginnote{3/11:}For Corollary \ref{cly:11.10}, do we need $a\in LP(A)$ for the other case?
    \begin{itemize}
        \item Perhaps also show limits for the last three cases?
    \end{itemize}
    \item For Corollary \ref{cly:11.12}, present the 0 case and then induct from 1?
    \item 9.11?
    \item 11.7: $x\in R\cap A$ the second time around?
\end{itemize}
